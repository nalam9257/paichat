...
class server:
    def chattingserver(self):
        ...
        lb=Message(win,text="Close window to start server .... ",font="times 14",width="200",bg="skyblue")
        lb.place(x=10,y=150)
        win.mainloop()
        c,addr=s.accept()
        ...
        def sender(*args):
            ...
            sendata=data.get()
            message = Message(canvas,text=sendata,width=350,pady=0,font=("gabriola",15),fg="black",bg='tomato')
        ...
        def receiver():
            ...
            while True:
                try:
                    ...
                    message = Message(canvas,text=data1,width=350,pady=0,font=("gabriola",15),fg="black",bg='skyblue')
        ...
        data=StringVar()
        textbox=Entry(win,bg="white",width=29,font="Times 19",textvariable=data)
        textbox.place(x=0,y=562)
